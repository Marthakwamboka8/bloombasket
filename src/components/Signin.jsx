...
const Signin = () => {
    ...
    return (
        <div className="row mt-4 justify-content-center body">
            <div className="col-md-6 card shadow p-4">
                ...
                <form action="" onSubmit={handlesubmit}>
                    <input type="email" clasNetwork Error className="form-control" placeholder="✉️Enter email" onChange={(e) => setEmail(e.target.value)} /><br />
                    ...
                    <p>Do you have an account? <Link toNetwork Error
